      ...
      <div className="space-y-4">
        {images.map((img, idx) => (
          ...
          >
            ...
            <Image src={img.image_urls} width={150} height={80} alt={`Hero ${img.id}`} className="rounded pointer-events-none" />
            ...
            <form action={deleteHeroBanner} onMouseDown={e => e.stopPropagation()}>
              ...
              <button
                type="submit"
                className="px-3 py-1 bg-red-600 text-white rounded hover:bg-red-700 transition-colors pointer-events-auto"
              >
                Delete
              </button>
            </form>
      ...
      {dragIdx !== null && (
        ...
        >
          <div className="flex items-center space-x-4 bg-white p-4 rounded-lg shadow-2xl">
            ...
            <Image src={images[dragIdx].image_urls} width={150} height={80} alt={`Hero ${images[dragIdx].id}`} className="rounded" />
